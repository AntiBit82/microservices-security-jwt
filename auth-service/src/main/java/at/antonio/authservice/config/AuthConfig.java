package at.antonio.authservice.config;

import at.antonio.authservice.service.CustomUserDetailsService;
...
@Configuration
@EnableWebSecurity // turn off default security, configure it on our own
